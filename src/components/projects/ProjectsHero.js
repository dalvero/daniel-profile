      ...
      <div className="relative w-full h-[100vh]">
        ...
        >
          <div className="max-w-6xl mx-auto w-full">
            ...
            {/* Main Headline — scroll-driven reveal + unreveal */}
            <motion.h1
            ...
            >
              <BlurText
                text="Setiap proyek adalah cerita tentang memecahkan masalah nyata dengan kode dan desain."
                stagger={0.003}
